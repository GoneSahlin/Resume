...
\entry{MAQ Software}{Software Engineer}{June 2024 -- Present}
{\begin{itemize}
	\item Developed data pipelines using Databricks, Fabric, and Azure Data Factory, transforming user telemetry data of AI tools into curated datasets enabling data science and reporting for ROI measurements
	\item Refactored and optimized Spark ML pipeline in Azure Databricks to cut runtime by 95\% and reduce monthly refresh delay from 3 days to overnight
	%	\item Led projects as the point of contact between customer stakeholders and our offshore development team
	\item Led a team of 5 engineers to deliver stakeholder defined requirements for SMB AI initiatives
	\item Proposed and implemented robust outlier filtering logic to resolve the unexpected variability of ROI calculations
%	\item Analyzed data in order to investigate and resolve data issues, drive requirements, and provide business insights
	\item Spearheaded requirement gathering by collaborating with stakeholders and proactively raising issues and concerns in order to provide clear technical specs streamlining development
	\item Managed multiple projects creating Power BI dashboards with 5,000+ monthly users for analyzing sales data for an enterprise cloud provider
...
%	\item Validated Spark notebooks and reports to verify project requirements were met and improve code stability
	\item Leveraged AI tools including Databricks Assistant, GitHub Copilot, and M365 Copilot daily to accelerate integration with a legacy database 
\end{itemize}
}
...
{\project{Machine Learning for Real Estate}{}{Python, SQL, PyTorch, JS, FastAPI}{Fall 2022 - Spring 2023}
	{\begin{itemize}
...
{\project{Resume Builder}{https://github.com/GoneSahlin/ResumeBuilder}{Python, JavaScript, TypeScript, React, Next.js, MongoDB, LaTeX, AWS Lambda}{Fall 2023}
	{\begin{itemize}
		\item Created a web app with React and Next.js to allow users to input resume content and manage multiple resumes
...
%    \item Data Science Algorithms and NLP
...
{\begin{itemize}
    \item Languages: Python, SQL, Java, C++
    \item Tools: PySpark, Databricks, Fabric, DuckDB, Git, Linux, Docker, Jupyter, GitHub Actions, Postgres, AWS Lambda, AWS S3, AWS ECR
