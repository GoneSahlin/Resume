...
{\begin{itemize}
	...
	\item Managed multiple projects creating Power BI dashboards with up to 5000 monthly users for analyzing sales data for a cloud provider.
...
{\begin{itemize}
    ...
    \item Tools: PySpark, Databricks, Fabric, Git, Linux, Docker, Jupyter, GitHub Actions, Postgres, AWS Lambda, AWS S3
